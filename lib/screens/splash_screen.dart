    ...
    return Scaffold(
      body: Stack(
        children: [
          // Background grid
          Positioned.fill(
            child: CustomPaint(painter: _GridPainter(Theme.of(context).brightness == Brightness.dark)),
          ),
          Center(
            child: Column(
                ...
                ScaleTransition(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      boxShadow: [BoxShadow(color: kPrimary.withOpacity(0.5), blurRadius: 40, offset: const Offset(0, 12))],
                    ),
          ...
          Positioned(
            ...
            child: Column(
              children: [
                Text('from', style: TextStyle(fontSize: 8, color: Colors.grey.shade500, fontWeight: FontWeight.w700, letterSpacing: 2)),
