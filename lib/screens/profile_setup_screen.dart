            ...
            children: [
              ...
              GestureDetector(
                onTap: () async {
                  ...
                  if (img == null) return;
                  // Upload to Firebase Storage and set URL
                },
              ...
              Align(alignment: Alignment.centerLeft,
                child: Text('DISPLAY NAME', style: TextStyle(fontSize: 9,
                    fontWeight: FontWeight.w900, color: kPrimary, letterSpacing: 2))),
              ...
              Align(alignment: Alignment.centerLeft,
                child: Text('ABOUT', style: TextStyle(fontSize: 9,
                    fontWeight: FontWeight.w900, color: kPrimary, letterSpacing: 2))),
              const SizedBox(height: 6),
